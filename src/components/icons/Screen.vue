<template>
	<div>
		<div class="bg-blue-800 w-24 h-24 pt-5 pl-5" style="clip-path: polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%);">
		<svg
	  class="fill-current text-teal-200 inline-block"
	  width="50"
	  height="50"
	  viewBox="0 0 24 24"
	  fill="none"
